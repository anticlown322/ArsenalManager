...
using ArsenalManager.UI.Core.Repository;
using ArsenalManager.UI.Core.Repository.Implementations;
using ArsenalManager.UI.MVVM.ViewModels;
using ArsenalManager.UI.MVVM.Views;
